...
public class Criterion {
	...
	public Map<String, Object> getParams(String oper, String field, String searchString, Map<String, Object> params) {
		if (Constant.OP_CONTAINS.equals(oper) || Constant.OP_DOES_NOT_CONTAINS.equals(oper)) {
			params.put(field, "%%" + searchString + "%%");
		} else if (Constant.OP_BEGINS_WITH.equals(oper) || Constant.OP_DOES_NOT_BEGIN_WITH.equals(oper)) {
			params.put(field, searchString + "%%");
